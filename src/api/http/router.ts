...
export const ROUTE_CONFIG = {
  iam: {
    base: '/api/v1/iam',
    routes: ['POST /login', 'POST /logout', 'GET /users', 'POST /users', 'GET /users/:id', 'PUT /users/:id', 'DELETE /users/:id'],
  },
  organizations: {
  ...
  invoices: {
    ...
    routes: ['GET /', 'POST /', 'GET /:id', 'PUT /:id', 'POST /:id/approve', 'POST /:id/reject', 'DELETE /:id'],
  },
  approvals: {
    base: '/api/v1/approvals',
    routes: ['GET /pending', 'POST /:id/decision', 'GET /chains', 'POST /delegate'],
  },
  payments: {
  ...
  integrations: {
    ...
    routes: ['GET /', 'POST /', 'GET /:id', 'PUT /:id', 'DELETE /:id', 'POST /:id/sync'],
  },
};
