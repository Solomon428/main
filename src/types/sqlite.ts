...
// Delivery Methods
export type DeliveryMethod = 'IN_APP' | 'EMAIL' | 'SMS' | 'SLACK' | 'TEAMS' | 'WEBHOOK' | 'PUSH';
...
export type NotificationPriority = 'LOW' | 'MEDIUM' | 'HIGH' | 'CRITICAL' | 'EMERGENCY';

// Notification Channel
export type NotificationChannel = 'IN_APP' | 'EMAIL' | 'SMS' | 'SLACK' | 'TEAMS' | 'WEBHOOK' | 'PUSH';
...
// Transaction Type
export type TransactionType = 'DEBIT' | 'CREDIT' | 'ADJUSTMENT' | 'FEE' | 'INTEREST';
...
export type ReconciliationItemStatus = 'UNMATCHED' | 'MATCHED' | 'DISPUTED' | 'ADJUSTED' | 'EXCLUDED';
...
export const SA_COMPLIANCE_RULES = {
  ...
  SUPPLIER_NAME_FUZZY_THRESHOLD: 0.80,
  REQUIRED_DUPLICATE_FIELDS: ['invoiceNumber', 'supplierName', 'totalAmount', 'invoiceDate'],
