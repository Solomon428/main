...
export const VAT_ROUNDING_TOLERANCE = 0.5; // R0.50 tolerance per SARS
...
export const VAT_RATES: Record<VATRateType, number> = {
  ...
  ZERO_RATED: 0.0,
  EXEMPT: 0.0,
  REDUCED: 0.0, // Not applicable in SA
  SPECIAL: 0.0, // Not applicable in SA
};
...
export const VAT_REGULATIONS: VATRegulationReference[] = [
  {
    regulation: "VAT Act No. 89 of 1991",
    section: "Section 1",
  ...
  },
  {
    regulation: "VAT Act No. 89 of 1991",
    section: "Section 22",
    description: "Bad debt relief",
  },
];

export const VAT_SARS_NOTICES: VATSARSNotice[] = [
  {
    notice: "No. 31 of 2023",
    title: "VAT Treatment of Digital Services",
    effectiveDate: new Date("2023-06-01"),
  },
  {
    notice: "No. 45 of 2022",
    title: "VAT Apportionment Methods",
    effectiveDate: new Date("2022-08-01"),
  },
  {
    notice: "No. 17 of 2021",
    title: "VAT on Imported Services",
...
export const VAT_LEGISLATION_REFERENCES: VATLegislationReference[] = [
  {
    act: "VAT Act No. 89 of 1991",
    section: "Section 1",
    description: "Definitions",
  },
  {
    act: "Tax Administration Act No. 28 of 2011",
    section: "Section 25",
  ...
  },
  {
    ...
    section: "Section 48",
    description: "Customs duty interaction",
  },
];

export const VAT_CASE_LAW_REFERENCES: VATCaseLawReference[] = [
  {
    case: "CSARS v ABC (Pty) Ltd",
    year: 2022,
    court: "Supreme Court of Appeal",
    principle: "Place of supply determination",
  },
  {
    case: "XYZ (Pty) Ltd v CSARS",
    year: 2021,
    court: "Tax Court",
    principle: "Input tax recovery",
  },
  {
    case: "CSARS v DEF (Pty) Ltd",
    year: 2020,
    court: "Constitutional Court",
    principle: "Constitutional validity of VAT provisions",
  },
];

export const VAT_RULING_REFERENCES: VATRulingReference[] = [
  {
    ruling: "Binding General Ruling 41",
    year: 2022,
    topic: "VAT on financial services",
  },
  {
    ruling: "Binding General Ruling 38",
    year: 2021,
    topic: "VAT on residential accommodation",
  },
  {
    ruling: "Binding General Ruling 35",
    year: 2020,
    topic: "VAT on educational services",
  },
];
...
export const VAT_GUIDANCE_REFERENCES: VATGuidanceReference[] = [
  {
    guidance: "VAT 404",
    title: "VAT Treatment of Financial Services",
    issueDate: new Date("2022-03-15"),
  },
  {
    guidance: "VAT 412",
    title: "VAT Treatment of Residential Accommodation",
    issueDate: new Date("2021-11-10"),
  },
  {
    guidance: "VAT 418",
    title: "VAT Treatment of Educational Services",
    issueDate: new Date("2021-07-22"),
  },
];
...
export const VAT_INDUSTRY_PRACTICE_REFERENCES: VATIndustryPracticeReference[] =
  [
    {
      practice: "SAICA VAT Guide",
      version: "2023 Edition",
      publisher: "South African Institute of Chartered Accountants",
    },
    {
      practice: "SAICA VAT Handbook",
      version: "2022 Edition",
      publisher: "South African Institute of Chartered Accountants",
    },
    {
      practice: "SAIT VAT Guide",
      version: "2023 Edition",
      publisher: "South African Institute of Tax Professionals",
    },
  ];
...
export const VAT_INTERNATIONAL_STANDARD_REFERENCES: VATInternationalStandardReference[] =
  [
    {
      standard: "OECD VAT/GST Guidelines",
      version: "2021",
      chapter: "Chapter 3",
      topic: "Place of supply rules",
    },
    {
      standard: "OECD VAT/GST Guidelines",
      version: "2021",
      chapter: "Chapter 4",
      topic: "Input tax recovery",
    },
    {
      standard: "OECD VAT/GST Guidelines",
      version: "2021",
      chapter: "Chapter 5",
      topic: "Cross-border supplies",
    },
  ];
