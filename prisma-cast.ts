...
export const toPrismaNotificationChannel = (v: string): PrismaNotificationChannel =>
  v as PrismaNotificationChannel;

export const toPrismaNotificationPriority = (v: string): PrismaNotificationPriority =>
  v as PrismaNotificationPriority;
